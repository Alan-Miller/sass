...
<details><summary>Steps for creating aliases and functions in .bash_profile</summary><p>
  ...
  1. Open your .bash_profile using ```open -a Visual\ Studio\ Code ~/.bash_profile```. If you are using a Windows PC, type ```start``` instead of ```open```. This tells your computer to open .bash_profile in Visual Studio Code (remember to escape spaces in the name using '\ '). If you are using a different code editor, you will have to put that name here instead.
...
```sass
  ...
  @import './App';              /* App might be second its styles apply to other components */
  ...
  .App {
    ...
    .Login {
      .header {
        ...
        It is like writing a normal CSS selector like this: 
            .App .Login .header {
              color: black;
            }
         */
